...
def loss_func3(model):
    ...
    cross_entropy = tf.add(is_obj_loss, tf.multiply(non_obj_loss, 0.00005))
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(training_epochs):
            ...
            if (epoch != 0) and (epoch % 5 == 0):
                ...
                saver.save(sess, "velodyne_5th_try_" + str(epoch) + ".ckpt")
...
def test(batch_num, velodyne_path, label_path=None, calib_path=None, resolution=0.2, dataformat="pcd", label_type="txt", is_velo_cam=False):
    ...
    with tf.Session() as sess:
        ...
        saver = tf.train.Saver()
        new_saver = tf.train.import_meta_graph("velodyne_5th_try_5.ckpt.meta")
